...
container.className="container-fluid"
 ...
 var paragraph=createTag("h3","description","Food Court");
...
button.addEventListener("click",submit);
 ...
 var foodlistLabel=label("foodlist","Choose The Foods :");
 var food1label=label("food1","Starters");
 var food2label=label("food2","Soup Items");
 var food3label=label("food3","Side dish");
 var food4label=label("food4","Main dish");
 var food5label=label("food5","Drinks");
...
var food1name=food("input","checkbox","food","food1","Starters","form-check-input" )
var food2name=food("input","checkbox","food","food2","Soup Items","form-check-input" )
var food3name=food("input","checkbox","food","food3","Side dish","form-check-input" )
var food4name=food("input","checkbox","food","food4","Main dish","form-check-input" )
var food5name=food("input","checkbox","food","food5","Drinks","form-check-input" )
